/*
   ...
   version 6.6.6 - Stollen by me 25.02.2017 :D
...
BMP180::BMP180(protocol::I2C& i2c): m_i2c(i2c)
// Base library type
{
}
...
{
   auto reg = values[0];
   return m_i2c.ReadRegister(reg, (char *)values, length);
}
...
{
   return  m_i2c.Transmit((char *)values , length);
}
